	...
	<div class="row bg-preventa">
		...
		<div class="col-xs-12 col-md jumbotron">
			<div class="row">
				...
				<div class="col-md-6">
					<?php echo do_shortcode('[contact-form-7 id="165" title="Formulario Preventa"]'); ?>
				</div>
			</div>
		</div>
	</div>
...
<div class="jumbotron jumbotron-fluid bg-inverse text-white spacer-y">
	<div class="container text-xs-center">
		<p class="h3 display-4">Cada modelo está diseñado para brindar espacios flexibles, confort y eficiencia energética.<br>Sistema de construcción en 120 días.</p>
		<br><a class="btn btn-default">cotizá on-line</a>
	</div>
</div>
